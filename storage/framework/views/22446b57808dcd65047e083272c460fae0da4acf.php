...
<?php endif; ?>
                <div class="mb-3 ">
                    <input type="text" name="danhmuc" value="<?php echo e(old('danhmuc')); ?>"class="form-control" placeholder="Nhập danh mục" id="slug"
...
<?php echo $__env->make('layout/admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webdoctruyen3\resources\views/Admin/comic_category.blade.php ENDPATH**/ ?>