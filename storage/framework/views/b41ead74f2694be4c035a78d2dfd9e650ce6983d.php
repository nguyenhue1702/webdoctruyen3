...
<?php $__env->startSection('formtheloai'); ?>
<div class="col-9  reponsive-col9">
        <div class="row nav-bread reponsive-col9">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="">
                <ol class="breadcrumb">
                    ...
                    <?php $__currentLoopData = $tl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e($item->theloai); ?></li>
        ...
        <div class="row reponsive-col9 wow fadeInLeft bgnew" data-wow-delay="0.8s" data-wow-duration="2s">
            <div class="styleh3 px-3 py-2">
                <h3>Thể Loại : <?php echo e($item->theloai); ?></h3>
            ...
            <?php else: ?>
                ...
                <?php $__currentLoopData = $truyen->tl_Truyens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="product-card d-flex flex-row align-items-center">
                            ...
                            <div class="noidung">
                                <div class=" div-one px-2 py-2">
                                    <div class="">
                                    <h5 class="mb-1"><?php echo e($item->name_product); ?>
                                ...
                                <div><i class="bi bi-heart-fill"></i></div>
                                    ...
                                    <div class=" style-dm size-edit">
                                        ...
                                        <div class="mini-dm py-1"><a href=""><?php echo e($danhmucs->danhmuc); ?>  </a></div>
                                       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                        ...
                                        <div class="  style-dm size-edit">
                                            ...
                                            <div class="mini-tl py-1"><a href="" class="tag-new"><?php echo e($theloais->theloai); ?>  </a></div>
                                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
...
<?php echo $__env->make('layout/website_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webtruyen3\resources\views/Website/form_theloai.blade.php ENDPATH**/ ?>