            ...
            <div class="row bg-color px-5 py-5 form-re">
                ...
                <div class="col-5">
                    <div class="mb-3 title ">
                        ...
                        <div><a href="<?php echo e(route('FormLoginAdmin')); ?>">LOGIN</a>&nbsp;  |&nbsp;  <a href="<?php echo e(route('Home')); ?>"><i class="fa-solid fa-house" style="font-size: 20px"></i></a></div>
                    </div>
                    ...
                    <div class="mb-3 tranform-i">
                        ...
                        <div class="input-i">
                            <input type="text" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Enter Email" name="email" value="<?php echo e(old('email')); ?>">
...
<?php /**PATH C:\xampp\htdocs\webtruyen3\resources\views/User/register.blade.php ENDPATH**/ ?>