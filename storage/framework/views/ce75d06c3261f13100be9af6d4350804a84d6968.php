            ...
            <tbody>
                <?php $__currentLoopData = $list_truyen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $truyen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <textarea name="" id="" cols="20" rows="3" disabled><?php echo e($truyen->content_product); ?></textarea>
                        </td>
...
<?php echo $__env->make('layout/admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webtruyen3\resources\views/Admin/product_list.blade.php ENDPATH**/ ?>