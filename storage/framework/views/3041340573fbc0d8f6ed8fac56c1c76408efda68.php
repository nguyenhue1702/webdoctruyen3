...
<?php $__env->startSection('banner_edit'); ?>
<div class="row ">
    <div class="col-3"></div>
    ...
    <div class="col-6 style-input">
        ...
        <form action="<?php echo e(route('update_banner',$banners->id)); ?>" enctype="multipart/form-data" method="POST">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            <div class="mb-3 ">
                <label for="">Title Banner :</label>
                <input type="text" name="title_banner" placeholder=" Enter Title Banner" class="form-control" value="<?php echo e($banners ->title_banner); ?>"
                   >
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <?php if('show'== $banners ->show_banner): ?>
            ...
            <div class="mb-3">
                <img type src="/uploads/img_banner/<?php echo e($banners->img_banner); ?>" alt="" style="width:870px; height:350px" id="image" style="background-size:cover;">
            </div>
            <div class="mb-3">
...
<?php echo $__env->make('layout/admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webtruyen3\resources\views/Admin/banner_edit.blade.php ENDPATH**/ ?>