<div class=" tuannn">
    <div class="side-bar-right">
        ...
        <div class="khung mt-3 wow fadeInRight" data-wow-delay="0.8s" data-wow-duration="1s">
            ...
            <div class="menulist bgnew">
                <ul>
                    ...
                    <li> <a href="{{ route('trangtruyen', [$item->id, $item->slug_product]) }}"><img src="/uploads/img_truyen/{{ $item->img_product }}" alt="" width="30px" height="30px">&nbsp;&nbsp;&nbsp;{{ $item->name_product }}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
        ...
        {{-- @ Truyện yêu thích--}}
        @if (Session::has('name'))
        @if(!empty($listfavourite) && isset($listfavourite))

        @if (count($listfavourite) == 0)
        <div>
            <div class="khung">
                <div class="title style-lottie">
        ...
        <div class="khung">
            ...
            <div class="menulist bgnew">
                <ul>
                    ...
                    <li> <a href="{{ route('trangtruyen', [$item->Favourite_product->id, $item->Favourite_product->slug_product]) }}"><img src="/uploads/img_truyen/{{ $item->Favourite_product->img_product }}" alt="" width="30px" height="30px">&nbsp;&nbsp;&nbsp;{{ $item->Favourite_product->name_product }}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
