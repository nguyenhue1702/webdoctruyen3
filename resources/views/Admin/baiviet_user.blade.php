                    ...
                    <tbody>
                        @foreach ($list as $item)
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" class="toggle-baivietuser" data-id="{{ $item->id }}"
                                        data-toggle="toggle" data-style="slow" data-on="Success"
                                        data-off="Waiting"{{ $item->apply == true ? 'checked' : '' }}>
                                ...
                                <td>
                                    <div class="thaotac">
                                        <button><a href="{{ route('edit_bv_user', $item->id) }}" class="btn-sua"><i
                                                    class="fa-solid fa-wrench"></i></a></button>&nbsp;&nbsp;

                                        <form action="{{ route('delete_bv_user', $item->id) }}" method="post"
                                            class="dele">
                                            @csrf
                                            @method('DELETE')
